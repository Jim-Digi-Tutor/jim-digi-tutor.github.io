---
permalink: tutorials/files-and-folders/files-and-folders-6.html
layout: article-no-aside
type: article-no-aside
subtitle: Part 5
pageTitle: "Tutorial: Intro to Files & Folders"
title: "Finding Folders 2"
css: basic-skills
  ...
  <section>
    ...
    <div class="console">
      ...
      <div class="console-section">   
        ...
        <p>
          Open (go into) the folder <span class="emphasise">Work Documents</span>. When you have done it, you'll get a green tick. When you are done, click <span class="emphasise">Next Section</span> to move on.
        </p>
    ...
    <div class="link-row">
      <div><a href="./files-and-folders-5.html">&#8592;&nbsp;Previous Section</a></div>
      <div><a href="./files-and-folders-7.html">Next Section&nbsp;&#8594;</a></div>
    </div>
