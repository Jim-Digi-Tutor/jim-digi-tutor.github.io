---
permalink: tutorials/files-and-folders/files-and-folders-7.html
layout: article-no-aside
type: article-no-aside
subtitle: Part 5
pageTitle: "Tutorial: Intro to Files & Folders"
title: "Finding Folders 3"
css: basic-skills
  ...
  <section>
    ...
    <div class="console">
      ...
      <div class="console-section">   
        ...
        <p>
          Navigate to and open the folder <span class="emphasise">Timetable</span>. When you are done, click <span class="emphasise">Next Section</span> to move on.
        </p>
    ...
    <div class="link-row">
      <div><a href="./files-and-folders-6.html">&#8592;&nbsp;Previous Section</a></div>
      <div><a href="./files-and-folders-8.html">Next Section&nbsp;&#8594;</a></div>
    </div>
