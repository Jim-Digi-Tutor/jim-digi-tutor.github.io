...
const palette = {
  ...
  "button-disc": new THREE.MeshStandardMaterial( { color: 0x656565, roughness: 1, metalness: 0 } ),
  "button-symbol": new THREE.MeshStandardMaterial( { color: 0xFF0000, roughness: 1, metalness: 0 } ),
...
export async function loadCommonGlb(path, merge, scale, rot, remap, renderer) {
...
export async function loadRegionModel(path, merge, scale, renderer) {
