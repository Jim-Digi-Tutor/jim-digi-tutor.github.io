        ...
        promises.push(
          await UTILS.loadCommonGlb(
            ...
            model.children.forEach(child => {
              ...
              const flags = mod.userData?.flags ?? "xxxx";
              if(logMod && this.#log) console.log("------ Flags " + flags);
              const common = (flags.charAt(0) === "c") ? true : false;
              const merge = (flags.charAt(1) === "m") ? true : false;
              const collidable = (flags.charAt(2) === "c") ? true : false;
              const visible = (flags.charAt(3) === "v") ? true : false;
              const noScale = (flags.charAt(4) === "n") ? true : false;
              ...
              if(common) {
                ...
                if(c !== null) {
                  ...
                  // Switch Y- and Z-axis rotation
                  mod.rotation.set(rx - THREE.MathUtils.degToRad(0), rz, ry);
