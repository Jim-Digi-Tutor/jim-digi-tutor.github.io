...
export class Region {
      ...
      await UTILS.loadRegionModel(
        ...
        model.children.forEach(child => {
          ...
          if(alias !== null && alias === this.#alias) {
            ...
            mod.position.set(
              UTILS.scaleDistance(this.#position.x, uniScale, modScale),
              UTILS.scaleDistance(this.#position.y, uniScale, modScale),
              UTILS.scaleDistance(this.#position.z, uniScale, modScale)
            );
  ...
  manageProximity(data) {
    ...
    if(data.proximity !== this.#proximity) {
      ...
      } else if(this.#proximity === "ADJACENT") {

        reloadModels = true;
        
      } else if(this.#proximity === "NEAR") {

        if(this.#proximity !== "DISTANT")
          reloadModels = true;

      } else if(this.#proximity === "DISTANT") {

        if(this.#proximity !== "NEAR")
          reloadModels = true;

      } else if(this.#proximity !== "REMOTE") {
