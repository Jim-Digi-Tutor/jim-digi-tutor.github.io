import { InfoBoard } from "./sub-components/info-board.js";
...
export class InfoBoardManager {
  ...
  /**
   * Creates and InfoBoardManager.
   * @param {Region} region The parent region of this manager.
   * @param {XML} The data from which the boards are constructed.
  */
  ...
  processInfoBoards(isXML) {
    ...
    for(let a = 0; a < data.length; a++) {
      ...
      const board = new InfoBoard(this, data[a], isXML);
      board.buildBoard();
