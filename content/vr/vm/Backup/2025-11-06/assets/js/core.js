...
// === XRPerfHUD (head-locked canvas quad) ================================
// Usage:
//   const xrHud = createXRPerfHUD(renderer, camera);
//   in your animate(): xrHud.update();
//   (Works in non-XR too; it just sticks to the regular camera.)

function createXRPerfHUD(renderer, camera, opts={}) {
...
#xrHud;
 ...
 // Meta 2 Settings & Meta 3 seem to be the same
  // Headset testing m3
  #splashOffset = new THREE.Vector3(0, 0, 0.3);
  #locOffset = new THREE.Vector3(0, -0.275, 0.8);
  #debugOffset = new THREE.Vector3(-0.50, 0.3, 0.8);
...
this.#xrHud = createXRPerfHUD(this.#renderer, this.#camera);
