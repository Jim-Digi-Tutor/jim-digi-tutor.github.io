...
scene.traverse((obj) => {
    ...
    // Remove and dispose geometries
    if (obj.geometry) {
      obj.geometry.dispose();
    }

    // Remove and dispose materials and textures
    if (obj.material) {
    ...
    // If InstancedMesh has instance matrices etc. to free
...
// Helper: dispose material + all textures + uniforms
function disposeMaterial(material) {

  // Textures (map, normalMap, etc.)
